...
export const SPREADS: Spread[] = [
  {
    id: 'single',
    name: 'Single Card',
    description: 'One card drawn for reflection',
    cardCount: 1,
    positions: [
      { name: 'The Card', description: 'The single drawn card' },
    ],
    interpretPrompt: 'Please interpret this single tarot card drawing.',
  },
  {
    id: 'three-card',
    name: 'Three Card',
    description: 'Three cards representing past, present, and future',
    cardCount: 3,
    positions: [
    ...
    interpretPrompt: 'Please interpret this three-card tarot spread. The positions represent past, present, and future.',
  },
  {
    id: 'five-card',
    name: 'Five Card Cross',
    description: 'A cross layout examining a situation from multiple angles',
    cardCount: 5,
    positions: [
      { name: 'Present', description: 'The current situation' },
      { name: 'Challenge', description: 'What crosses the situation' },
      { name: 'Past', description: 'What is behind' },
      { name: 'Future', description: 'What lies ahead' },
      { name: 'Outcome', description: 'Potential resolution' },
    ],
    interpretPrompt: 'Please interpret this five-card cross spread. The positions are: Present (center), Challenge (crossing), Past, Future, and Outcome.',
  },
  {
    id: 'celtic-cross',
    name: 'Celtic Cross',
    description: 'The traditional ten-card spread for examining a situation in depth',
    cardCount: 10,
    positions: [
      { name: 'Present', description: 'The current situation' },
      { name: 'Challenge', description: 'What crosses the situation' },
      { name: 'Foundation', description: 'The root of the matter' },
      { name: 'Past', description: 'Recent influences passing away' },
      { name: 'Crown', description: 'What crowns the situation' },
      { name: 'Future', description: 'What lies ahead' },
      { name: 'Self', description: 'The querent\'s attitude' },
      { name: 'Environment', description: 'External influences' },
      { name: 'Hopes & Fears', description: 'Hopes and fears' },
      { name: 'Outcome', description: 'The outcome' },
    ],
    interpretPrompt: 'Please interpret this Celtic Cross tarot spread. Analyze each position and how the cards relate to one another.',
  },
  {
    id: 'celtic-cross-plus',
    name: 'Celtic Cross + Clarifier',
    description: 'Celtic Cross with an additional clarifier card',
    cardCount: 11,
    positions: [
      { name: 'Present', description: 'The current situation' },
      { name: 'Challenge', description: 'What crosses the situation' },
      ...
      { name: 'Hopes & Fears', description: 'Hopes and fears' },
      { name: 'Outcome', description: 'The outcome' },
      { name: 'Clarifier', description: 'Additional context for the outcome' },
    ],
    interpretPrompt: 'Please interpret this Celtic Cross tarot spread with an additional clarifier card. Analyze each position, how the cards relate to one another, and what the clarifier adds to the outcome.',
  },
  {
    id: 'relationship-reflection',
    name: 'Relationship Reflection',
    description: 'A seven-card spread examining the dynamics of a relationship',
    cardCount: 7,
    positions: [
      { name: 'What I Bring', description: 'What the querent contributes' },
      { name: 'What They Bring', description: 'What the other person contributes' },
      { name: 'The Dynamic', description: 'The interaction between the two' },
      { name: 'My Blind Spot', description: 'What the querent may not see' },
      { name: 'Their Experience', description: 'How the other may experience the relationship' },
      { name: 'The Unspoken', description: 'What has not been expressed' },
      { name: 'The Lesson', description: 'What the relationship brings to light' },
    ],
    interpretPrompt: 'Please interpret this Relationship Reflection spread. The seven positions examine what each person brings, the dynamic between them, blind spots, unspoken elements, and what the relationship brings to light.',
  },
  {
    id: 'right-hand-of-eris',
    name: 'Right Hand of Eris',
    description: 'A five-card decision-making spread with two possible outcomes',
    cardCount: 5,
    positions: [
      { name: 'Your Question', description: 'The nature of what is being asked' },
      { name: 'What May Help', description: 'What supports the situation' },
      { name: 'What May Hinder', description: 'What works against the situation' },
      { name: 'Outcome One', description: 'One possible outcome' },
      { name: 'Outcome Two', description: 'Another possible outcome' },
    ],
    interpretPrompt: 'Please interpret this Right Hand of Eris spread. The positions are: the question itself, what may help, what may hinder, and two possible outcomes.',
  },
];
